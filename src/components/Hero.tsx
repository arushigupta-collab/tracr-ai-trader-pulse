          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link to="/register">
              <Button 
                variant="default" 
                size="xl" 
                className="bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-pantone-171 hover:border-pantone-171 hover:text-white hover:scale-105 hover:shadow-xl hover:shadow-pantone-171/30 transition-all duration-300 px-8 py-4 rounded-2xl font-medium text-lg"
              >
