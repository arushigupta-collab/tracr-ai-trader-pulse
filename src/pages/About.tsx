          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="animate-fade-in">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-white">
                About <span style={{ color: 'hsl(330, 92%, 65%)' }}>tracr ai</span>
              </h1>
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-16 animate-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight text-white">
                Revolutionizing Trading Through <span className="whitespace-nowrap" style={{ color: 'hsl(15, 85%, 75%)' }}>AI Intelligence</span>
              </h2>
